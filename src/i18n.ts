...
const en: Record<string, string> = {
  ...
  'easy.status.initializing': 'Starting AI...',
  'easy.status.ready': 'Ready',
  'easy.status.thinking': 'AI is thinking...',
  'easy.status.tool_running': 'AI is working...',
  ...
  'easy.preview.empty_desc': 'Ask AI to build a webpage and it will appear here automatically.',
  ...
  'easy.msg.stopped': 'AI has stopped. ',
  'easy.msg.restart': 'Restart AI',
  'easy.msg.stuck': 'AI seems to be taking a while...',
  ...
  'easy.invite.desc': 'Share this link — anyone who opens it can join this session in real time, chat together, and work on the same project.',
  ...
  'pro.switch.confirm_exit': 'Switching to Easy Mode will exit the current session. Continue?',
...
const zh: Record<string, string> = {
  ...
  // Easy Mode
  'easy.title': '立码 简单模式',
  'easy.status.initializing': '小码 启动中...',
  'easy.status.ready': '就绪',
  'easy.status.thinking': '小码 思考中...',
  'easy.status.tool_running': '小码 处理中...',
  ...
  'easy.preview.empty_desc': '请小码构建一个网页，完成后会自动在这里显示。',
  ...
  'easy.msg.stopped': '小码 已停止。',
  'easy.msg.restart': '重启小码',
  'easy.msg.stuck': '小码 似乎卡住了...',
  'easy.msg.retry': '重试',
  ...
  'easy.invite.desc': '分享链接给同事，打开即可加入当前会话，实时对话、一起完成项目。',
  ...
  'pro.switch.confirm_exit': '切换到简单模式需要退出当前的会话。确定继续？',
